"""
This file contains API view functions for adding various entities.
It includes endpoints for adding universities, colleges, schools, departments, modules, and lecturers.
"""
...
def add_lecturer_api(request):
    ...
    lecturer = Lecturer.objects.create(name=name, title=title, department=department)
    return JsonResponse({
        'id': lecturer.id, 
        'name': lecturer.name, 
