...
urlpatterns = [
    ...
    # path('api/department/search/', views.search_department_api, name='search_department_api'),
    ...
    path('api/department/add/', views.add_department_api, name='add_department_api'),  # Add a new department
