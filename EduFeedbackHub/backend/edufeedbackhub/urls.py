...
urlpatterns = [
    ...
    path('api/rankings/<int:year>/', views.qs_year_detail_api, name='qs_year_detail_api'),# Rankings detail for a specific year

    ## Institute detail & comments add or delete
    path('api/university/<int:university_id>/', views.university_detail_api, name='university_detail_api'),# University details and comments
    path('api/college/<int:college_id>/', views.college_detail_api, name='college_detail_api'),# College details and comments
    path('api/school/<int:school_id>/', views.school_detail_api, name='school_detail_api'),# School details and comments
    path('api/module/<int:module_id>/', views.module_detail_api, name='module_detail_api'),# Module details and comments
    path('api/teaching/<int:teaching_id>/', views.teaching_detail_api, name='teaching_detail_api'),# Teaching record details and comments
    path('api/comment/add/', views.add_comment_api, name='add_comment_api'),  # Add a new comment
    path('api/comment/<int:comment_id>/delete/', views.delete_comment_api, name='delete_comment_api'),# Delete a comment by ID

    ## Search APIs
    path('api/university/search/', views.search_university_api, name='search_university_api'),# Search universities by name
