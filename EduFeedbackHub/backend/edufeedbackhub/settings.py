"""
Django settings for EduFeedbackHub project.
...
SECRET_KEY = 'django-insecure-tch=3w9fas9t8e$jw@7$k&18_6(7ni0r0x-oe!wz2tb1a&ow(@'
...
TEMPLATES = [
    {
        ...
        # Navigate three levels up to reach EduFeedbackHub/templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
